<html>
    ...
    <body>
        <div class="top" style="position:fixed; height:100px; width:100%; background-color:rgb(74, 160, 74);color: white;z-index:100; border-bottom:3px white solid"><div class=" logo pull-left" style="margin-left:15px;margin-top:10px"><img src="home.jpg" style="height:80px" /></div><div class=" span6"><h4> NEOGEN LABS PVT LTD </h4><br />  INVOICE MANAGEMENT SYSTEM ADMIN PANEL</div>
<div class="span1 logout pull-right btn btn-info" style="margin-top:30px; margin-right:20px">Logout</div>        </div>
        <div class="left-sidebar" style="position:fixed; border-right : 3px black solid ; width:150px; background-color: rgb(74, 160, 74); height:100%">
  ...
  <?php echo $content ; ?>
        ...
        <div class="footer" style="position: fixed; bottom: 0 ;height:40px; width:100%; background-color: rgb(74, 160, 74);border-top:3px white solid ">
