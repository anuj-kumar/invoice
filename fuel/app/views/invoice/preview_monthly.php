<html>
                ...
                <tr>
                    <td style="width:350px;">
                        <ul style="padding-left: 0px">
                            <li><input type="text" name="org_name" class="formee-large" placeholder="Org Name"  value ="<?php echo $monthly_customer->org_name; ?>" required autofocus></li>
    ...
    <div class="span4" style="margin-left: 47% ">
        <?php echo Html::anchor('invoice/print_monthly/' . $invoice_id, 'Print' , array('target'=>'blank')); ?>
