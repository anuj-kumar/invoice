...
<fieldset>
    <div class="grid-12-12 ">
        ...
        <div class="grid-3-12 ">
            ...
            <input type="text" name="name" class="formee-large" value="<?php echo $monthly_customers->customer->first_name; ?>" placeholder="Name" required>
        </div>
    </div>  
    ...
    <div class="grid-12-12 " style="margin-top: -20px">
        <div class="grid-4-12 ">
            ...
            +<input type='tel' name="tele" pattern='\d{2}' placeholder='Tele: (91)' autocomplete="off" value="91"  style="width: 20px" required><input type='tel' name="tele" pattern='\d{10}' style="width: 100px;margin-left: 10px " placeholder='9999999999' autocomplete="off" value="<?php echo $monthly_customers->customer->phone; ?>" required>
        </div>
        <div class="grid-4-12 ">
    ...
    <div class="grid-12-12 " style="margin-top: -20px">
        <div class="grid-4-12 ">
            <h4 ><a href="<?php echo $monthly_customers->contract_file ?> " style="color:red">Contract File</a></h4>
        </div>
