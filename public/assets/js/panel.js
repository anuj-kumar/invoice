      function addRow(tableID) {
    ...
                element1.type = "text";
                element1.name = "volume_low";
                element1.style.width = "20px";
                cell1.appendChild(element1);
    
                var element2 = document.createElement("input");
                element2.type = "text";
                element2.name = "volume_high";
